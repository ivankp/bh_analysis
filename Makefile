...
all: $(DIRS) bin/inspect_bh bin/reweigh bin/plot bin/merge_parts bin/overlay bin/overlay2 bin/scale bin/cross_section $(HIST_EXE)
...
# main objects ######################################################
lib/inspect_bh.o lib/reweigh.o lib/plot.o lib/merge_parts.o lib/overlay.o lib/overlay2.o lib/hist_weights.o lib/cross_section_hist.o lib/cross_section_bh.o lib/scale.o lib/cross_section.o: lib/%.o: src/%.cc
...
# executables #######################################################
bin/cross_section_bh bin/cross_section_hist bin/inspect_bh bin/merge_parts bin/scale: bin/%: lib/%.o
...
bin/overlay bin/overlay2: bin/%: lib/%.o
	@echo -e "Linking \E[0;49;92m"$@"\E[0;0m"
